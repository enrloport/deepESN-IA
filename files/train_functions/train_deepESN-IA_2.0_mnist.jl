function __fill_X_deepESNIA2_mnist!(deepE, args::Dict )
...
function __make_Rout_deepESNIA2_mnist!(deepE,args)
    X             = deepE.X
...
function __do_train_deepESNIA2_mnist!(deepE, args)
    ...
    __fill_X_deepESNIA2_mnist!(deepE,args)
    __make_Rout_deepESNIA2_mnist!(deepE,args)
end
